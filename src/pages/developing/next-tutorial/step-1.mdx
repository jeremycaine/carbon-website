...
[carbon-tutorial-next](https://github.com/carbon-design-system/carbon-tutorial-next)
that we'll use as a starting point for each step.

### Fork

To begin, fork
[carbon-tutorial](https://github.com/carbon-design-system/carbon-tutorial-next)
...
```bash
git remote add upstream git@github.com:carbon-design-system/carbon-tutorial-next.git
```

#### HTTPS

```bash
git remote add upstream https://github.com/carbon-design-system/carbon-tutorial-next.git
```
...
upstream	git@github.com:carbon-design-system/carbon-tutorial-next.git (fetch)
upstream	git@github.com:carbon-design-system/carbon-tutorial-next.git (push)
```
...
In `src` directory, rename `global.css` as `globals.scss` and change the import
...
```javascript path=src/providers.js
'use client';
...
fix this, we'll add the following override in `globals.scss` below our style
import:
...
Finally, visit
[carbon-next-tutorial](https://github.com/carbon-design-system/carbon-tutorial-next)
